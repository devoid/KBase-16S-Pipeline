package Bio::KBase::Tornado::Server;
...
sub call_method {
    ...
    my $ctx = Bio::KBase::Tornado::ServerContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

        # Service Tornado does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service Tornado.");
    }
...
package Bio::KBase::Tornado::ServerContext;

use strict;

=head1 NAME

Bio::KBase::Tornado::ServerContext
